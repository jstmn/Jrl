...
""" 
python scripts/visualize_robot_meshcat_cp.py --robot_name panda
python scripts/visualize_robot_meshcat_cp.py --robot_name fetch

"""

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--robot_name", type=str, required=True, help="Example: 'panda', 'baxter', ...")
