...
# from tests.ground_truth_kinematics_data import get_gt_samples_and_endpoints # TODO: Get ground truth FK data
...
class TestForwardKinematics(unittest.TestCase):
    ...
    def get_fk_poses(
        self, robot: KinematicChain, samples: np.array, verbose=False
    ...
    # Tests
    # TODO: add kinpy to this file, or delete entirely
    ...
    # TODO: Get ground truth FK data and implement this test
